...
export const config = {
  matcher: [
     ...
     * - / (root page)
     */
    "/((?!api/auth|api/webhook|_next/static|_next/image|favicon.ico|login|register|forgot-password|reset-password|contact|privacy-policy|terms|refund-policy|shipping-policy|$).*)",
  ],
};
